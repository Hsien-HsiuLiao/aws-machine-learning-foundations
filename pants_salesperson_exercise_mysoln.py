...
###
    def display_sales(self):
        for pants in range(len(self.pants_sold)):
            print("color: ", self.pants_sold[pants].color,
                 ", waist_size: ", self.pants_sold[pants].waist_size,
                 "length: ", self.pants_sold[pants].length,
                 "price: ", self.pants_sold[pants].price)
...
def check_results():
  ...
  #  print(salesperson.calculate_commission(.1))
